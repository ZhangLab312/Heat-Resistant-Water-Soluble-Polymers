...
# 配置参数 - 更新路径以匹配您的文件
CONFIG = {
    "input_csv": "E:/Python/pythonProject/new_t_predict/data/Tm_raw.csv",
    "output_csv": "E:/Python/pythonProject/new_t_predict/data/fnn_Tm_predictions.csv",
    "model_path": "E:/Python/pythonProject/new_t_predict/model/fnn_Tm_model.pth",
    "scaler_path": "E:/Python/pythonProject/new_t_predict/scaler/fnn_Tm_scaler.pkl",
    "fingerprint": {
        "radius": 3,
        "n_bits": 512
    },
